...
const products: Product[] = [
  {
    ...
    href: '#',
    imageSrc: '/mentors/assets/mentor/boy1.svg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/mentors/assets/mentor/boy2.svg',
    imageAlt: "Front of men's Basic Tee in black.",
  ...
  },
  {
    ...
    name: 'SEO Expert',
    href: '#',
    imageSrc: '/mentors/assets/mentor/boy3.svg',
    imageAlt: "Front of men's Basic Tee in black.",
  ...
  },
  {
    ...
    name: 'UI/UX Designer',
    href: '#',
    imageSrc: '/mentors/assets/mentor/boy4.svg',
    imageAlt: "Front of men's Basic Tee in black.",
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/mentors/assets/mentor/boy5.svg',
    imageAlt: "Front of men's Basic Tee in black.",
    color: 'Brad Schiff',
  },
  {
    ...
    href: '#',
    imageSrc: '/mentors/assets/mentor/girl1.svg',
    imageAlt: "Front of men's Basic Tee in black.",
